	...
	return (
		<div className={className}>
			<Drawer direction={"left"} open={isOpen} onOpenChange={setIsOpen}>
				...
				{/*fixed top-[-100px] bottom-[-100px] left-0*/}
				<DrawerContent className="h-full min sm:fixed sm:bottom-0 rigth-auto sm:right-0 sm:top-0 sm:mt-0 sm:flex sm:h-full w-2/3 sm:flex-col sm:overflow-hidden rounded-none sm:bg-white sm:shadow-xl lg:w-1/3">
