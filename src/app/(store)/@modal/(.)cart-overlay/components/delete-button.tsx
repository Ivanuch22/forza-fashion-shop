const DeleteButton = ({ onClick }: { onClick: () => Promise<void> }) => {
	return (
		<>
			<button type="button" onClick={onClick} className="w-[100%] h-[100%] group" aria-label="Remove">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 16 16"
					aria-hidden="true"
					focusable="false"
					className="w-[100%] h-[100%] fill-current text-gray-500 group-hover:text-red-500 transition-colors"
				>
