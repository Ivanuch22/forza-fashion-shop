...
const Guarantee = async () => {
	const t = await getTranslations("/product.guaranteeBlock");
	return (
		<div>
			<section
				id="shopify-section-template--18466364227834__slideshow_6WEydz"
			...
			>
				...
				>
					<div
						className="slideshow banner banner--medium grid grid--1-col slider slider--everywhere banner--mobile-bottom"
						id="Slider-template--18466364227834__slideshow_6WEydz"
						aria-live="polite"
						aria-atomic="true"
						data-autoplay="false"
						data-speed="5"
					>
						<div
							className="relative lg:pb-[40%] slideshow__slide grid__item grid--1-col slider__slide"
							id="Slide-template--18466364227834__slideshow_6WEydz-1"
							role="group"
							...
							<div className="sm:absolute sm:top-[20%] sm:left-[10%] sm:text-white ">
								<div className=" w-[90%] m-[0_auto] lg:w-[40%] lg:text-left sm:m-[0_0] slideshow__text banner__box banner--transparent-white content-container content-container--full-width-mobile color-background-1 color-scheme-template--18466364227834__slideshow_6WEydz-slide_zCbQ4R gradient slideshow__text--left slideshow__text-mobile--center">
									...
									<div
										...
										className=" lg:text-left tracking-[0.02rem] text-[1rem] text-center"
									>
